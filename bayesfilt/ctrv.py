...
class CTRV(MotionModel):
    ...
    def compute_Q(
        ...
        out_Q[2, 2] = sigma_sq[1] * self.dt ** 3 / 3.
        out_Q[2, 4] = sigma_sq[1] * self.dt ** 2 / 2.
        out_Q[3, 3] = sigma_sq[0] * self.dt ** 2 / 1.
        out_Q[4, 4] = sigma_sq[1] * self.dt ** 2 / 1.
        return out_Q
